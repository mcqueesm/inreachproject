...
namespace InReachProject
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Retrieve access keys for AWS from Azure Key Vault
            var awsOption = Configuration.GetAWSOptions();
            string publicKey = Configuration["publicKey"];
            string privateKey = Configuration["secretKey"];
            awsOption.Credentials = new BasicAWSCredentials(publicKey, privateKey);
